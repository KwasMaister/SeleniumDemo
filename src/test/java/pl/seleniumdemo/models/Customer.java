...
public class Customer {
    ...
    private String firstName = "Kuba";
    private String lastName = "Testowy";
    private String companyName = "Test Company";
    private String country = "Poland";
    private String street = "Ulica";
    private String flatNumber = "169";
    private String zipCode = "04267";
    private String city = "Cieszyn";
    private String phone = "123123123";
    private String email = "abcd@testowe.com.pl";
